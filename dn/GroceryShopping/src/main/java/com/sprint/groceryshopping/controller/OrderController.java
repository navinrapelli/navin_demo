...
public class OrderController {
	...
	@PostMapping("/orders")
	public ResponseEntity<OrderDTO> insertOrder(@Valid @RequestBody OrderDTO order) throws OrderNotFoundException {
	...
	@PutMapping("/orders")
	public ResponseEntity<List<OrderDTO>> updateOrder (@Valid @RequestBody OrderDTO order) throws OrderNotFoundException, DatabaseException {
